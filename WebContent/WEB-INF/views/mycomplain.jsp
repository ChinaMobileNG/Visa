...
<div class="all">
    <form wicket:id="form"
        ...
        <ul>
            <li><span wicket:id="lblMsg">请填写投诉信息</span></li>
            <li><span>被投诉人：</span> <label for="tousu_name"></label> <select
                    wicket:id="nameSelect"
                    name="tousu_name" id="tousu_name">

            </select>
            </li>
            <li><span>投诉原因：</span> <input class="a" name="name" id="flow" type="text" autocomplete="off"
                                          size="30" wicket:id="reason" maxlength="13"/></li>
            <li><span>详细说明：</span> <input class="a" type="text" autocomplete="off" id="desc"
                                          wicket:id="discription" size="30" maxlength="13"/>
            </li>
        </ul>
        <div class="btn-group">
            <input class="b b1" name="sb" type="submit" wicket:id="btnSubmit"

...
<body>
<s:url value="/message/deletemessages" var="deletemessages"/>
<form onsubmit="return checkValue();" id="id4" method="post" action="${deletemessages }">
	...
	<div id="content" class="white">
		...
		<div class="bloc left">
			...
			<div class="content">
				<div class="cb">
					<div class="submit">
						<input type="submit" value="删除留言" name="btnSubmit" id="id6">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="cb">
					...
					<table>
						...
						<tr>
							...
							<th><span>留言姓名</span></th>
							<th><span>留言号码</span></th>
						...
						<c:forEach items="${items }" var="item" varStatus="status">
							<tr>
								...
								<td><span>${item.messagername }</span></td>
								<td><span>${item.messagerphone }</span></td>
